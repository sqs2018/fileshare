...
public class StringUtils {
    ...
    public static String unicodeToChinese(String unicode) {
        try {
            return new String(Base64.getDecoder().decode(unicode.replace("@@", "")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getFileSize(double fileSize) {
        ...
        return String.valueOf(fileSize / (1024 * 1024 * 1024 * 1024)) + "TB";
    }

    public static void main(String[] args) {
        //String temp = chineseToUnicode("中");
        //System.out.println(temp.toString());
        String date = "2024-10-09T13:07:35.000+00:00";
