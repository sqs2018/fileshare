...
export const downloadFileUrl = (fileId) => {
  ...
  if (process.env.NODE_ENV === 'production') {
    return window.location.origin + `/v1/file/${fileId}/download?downloadUser=`+userName
  } else {
    return process.env.VUE_APP_API_URI + `/v1/file/${fileId}/download?downloadUser=`+userName
  }
}
